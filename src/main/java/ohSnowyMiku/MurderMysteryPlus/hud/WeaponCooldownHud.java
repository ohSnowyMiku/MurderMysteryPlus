...
import ohSnowyMiku.MurderMysteryPlus.event.hud.weaponcooldownhud.CountDownManager;

import static ohSnowyMiku.MurderMysteryPlus.config.MurderMysteryPlusConfig.WeaponCooldownHudPage.color;
