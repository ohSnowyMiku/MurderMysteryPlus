...
import static ohSnowyMiku.MurderMysteryHelper.event.events.tablistrole.ChatPlayerRoleListener.NAMETOPREFIX;
...
public class TabListEventHandler {
    ...
    public void onClientTick(TickEvent.ClientTickEvent e) {
        ...
        if (!MurderMysteryHelperConfig.showRolesInTabListFromChatSwitch) return;
