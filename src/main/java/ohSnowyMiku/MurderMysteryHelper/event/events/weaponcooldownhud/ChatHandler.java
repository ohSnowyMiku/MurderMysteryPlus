...
public class ChatHandler {
    ...
    private void sendMurdererChannelMessage(String msg) {
        ...
        if (msg.contains("§r§c你只能攻击平民和侦探！") || msg.contains("§r§cYou may only hit innocents and detectives!")) {
            mc.thePlayer.sendChatMessage("/m [MurderMysteryHelper] You have been stunned for 5 seconds!");
        }
    }
...
//[16:43:12] [main/INFO] (STDOUT) [ohSnowyMiku.MurderMysteryHelper.utils.ChatUtil:printLastChat:34]: 接收消息getFormattedText:§r§cYou have been stunned for 5 seconds!§r
//[16:43:12] [main/INFO] (STDOUT) [ohSnowyMiku.MurderMysteryHelper.utils.ChatUtil:printLastChat:35]: 接收消息getUnformattedText:You have been stunned for 5 seconds!
//[16:42:56] [main/INFO] (STDOUT) [ohSnowyMiku.MurderMysteryHelper.utils.ChatUtil:printLastChat:34]: 接收消息getFormattedText:§r§c你被击晕了，持续5秒！§r
//[16:42:56] [main/INFO] (STDOUT) [ohSnowyMiku.MurderMysteryHelper.utils.ChatUtil:printLastChat:35]: 接收消息getUnformattedText:你被击晕了，持续5秒！

//[02:55:44] [main/INFO] (STDOUT) [ohSnowyMiku.MurderMysteryHelper.utils.ChatUtil:printLastChat:34]: 接收消息getFormattedText:§r§c你只能攻击平民和侦探！§r
//[02:55:44] [main/INFO] (STDOUT) [ohSnowyMiku.MurderMysteryHelper.utils.ChatUtil:printLastChat:35]: 接收消息getUnformattedText:你只能攻击平民和侦探！

//[02:59:05] [main/INFO] (STDOUT) [ohSnowyMiku.MurderMysteryHelper.utils.ChatUtil:printLastChat:34]: 接收消息getFormattedText:§r§cYou may only hit innocents and detectives!§r
//[02:59:05] [main/INFO] (STDOUT) [ohSnowyMiku.MurderMysteryHelper.utils.ChatUtil:printLastChat:35]: 接收消息getUnformattedText:You may only hit innocents and detectives!